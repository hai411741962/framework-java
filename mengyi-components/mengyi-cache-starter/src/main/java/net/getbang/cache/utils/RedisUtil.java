...
public class RedisUtil {
     ...
     *
     * @param key               锁住的key
     * @param lockExpireSeconds 锁住的时长。如果超时未解锁，视为加锁线程死亡，其他线程可夺取锁
     * @return
     */
    public boolean setEx(String key, String value, long lockExpireSeconds) {
        return (boolean) redisTemplate.execute((RedisCallback) connection -> {
            //获取锁
            return connection.setEx(key.getBytes(), lockExpireSeconds, value.getBytes());
        });
    }
